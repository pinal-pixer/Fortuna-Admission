...
<form
    ...
    class="mba-simple-consultation-form"
>

    <input type="hidden" name="action" value="mba_simple_consultation_submit">

    <input type="hidden" name="mba_simple_consultation_submit" value="1">
    ...
    <input type="hidden" name="code" value="MBASimple">
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        form.addEventListener("submit", function (e) {
            ...
            window.dataLayer.push({ event: "MBASimpleFormSubmit" });
