...
= 1.2.8 - Thursday, 13th November 2025 =
* Improvement: Introduced a filter to allow user to receive the beta update notification for the Pro version.

= 1.2.7 - Wednesday, 17th September 2025 =
* Improvement: Login & Register Block: Implemented autocomplete="off" for the password field to prevent browser autofill for passwords.

= 1.2.6 - Wednesday, 3rd September 2025 =
* Fix: Loop Builder - Resolved an issue where for SureDash Community Post Type Taxonomy option is not visible.
