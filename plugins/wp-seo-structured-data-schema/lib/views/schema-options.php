				...
				<div class="setting-holder">
					<table width="40%" cellpadding="10" class="form-table">
							...
							<td align="left" scope="row">
								<div class="with-tooltip">
									<input type="text" class="regular-text" name="web_url"
										   value="<?php echo( ! empty( $settings['web_url'] ) ? esc_url( $settings['web_url'] ) : get_home_url() ); ?>"/>
						...
						<tr class="default">
							...
							<td align="left" scope="row">
								<input type="text" class="regular-text" name="type_name"
									   value="<?php echo( ! empty( $settings['type_name'] ) ? esc_attr( $settings['type_name'] ) : null ); ?>"/>
							</td>
						</tr>
							...
							<td align="left" scope="row">
								<div class="kSeo-image">
									<div class="kSeo-image-wrapper">
										...
										<input type="hidden" name="site_image" value="<?php echo absint($siteImageId); ?>"/>
									</div>
						...
						<tr class="default all-type-data">
							...
							<td align="left" scope="row">
								<input type="text" class="regular-text" name="site_price_range"
									   value="<?php echo( ! empty( $settings['site_price_range'] ) ? esc_html( $settings['site_price_range'] ) : null ); ?>"/>
						...
						<tr class="default all-type-data">
							...
							<td align="left" scope="row">
								<input type="text" class="regular-text" name="site_telephone"
									   value="<?php echo( ! empty( $settings['site_telephone'] ) ? esc_html( $settings['site_telephone'] ) : null ); ?>"/>
						...
						<tr class="default business-info">
							...
							<td align="left" scope="row">
								<textarea cols="50" rows="6"
										  name="business_info[description]"><?php echo( ! empty( $settings['business_info']['description'] ) ? esc_html( $settings['business_info']['description'] ) : null ); ?></textarea>
							</td>
						</tr>
						<tr class="default business-info">
						...
						<tr class="default person">
							...
							<td align="left" scope="row">
								<input type="text" class="regular-text" name="person[jobTitle]"
									   value="<?php echo esc_html( $settings['person']['jobTitle'] ?? null ); ?>"/>
									...
									<div class="kSeo-image">
										<div class="kSeo-image-wrapper">
											...
											<input type="hidden" name="organization_logo"
												   value="<?php echo absint( $organizationLogoId ); ?>"/>
										</div>
							...
							<tr class="social_field_link">
								...
								<th>
									<div id="social-field-holder">
										<?php
										$socialP = ( ! empty( $settings['social'] ) ? $settings['social'] : [] );
							...
							<tr class="field_contact">
								...
								<td align="left" scope="row">
									<select name="contact[contactOption]" class="select2 withEmptyOption"
										...
										echo( $cPtOpt == 'TollFree' ? 'selected' : null );
										?>
										><?php esc_html_e( 'TollFree', 'wp-seo-structured-data-schema' ); ?>
										</option>
										<option
							...
							<tr class="field_contact">
								...
								<td scope="row" class="lang">
									<select class="select2" name="availableLanguage[]" style="width: 50%"
											multiple="multiple">
										<?php
										$lanAvailable = ! empty( $settings['availableLanguage'] ) ? $settings['availableLanguage'] : [];
